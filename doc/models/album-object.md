...
| `tracks` | [`PagingSimplifiedTrackObject`](../../doc/models/paging-simplified-track-object.md) | Required | The tracks of the album. | getTracks(): PagingSimplifiedTrackObject | setTracks(PagingSimplifiedTrackObject tracks): void |
...
| `externalIds` | [`ExternalIdObject`](../../doc/models/external-id-object.md) | Required | Known external IDs for the album. | getExternalIds(): ExternalIdObject | setExternalIds(ExternalIdObject externalIds): void |
